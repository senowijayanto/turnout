  ...
  <div class="">
    ...
    <div class="form" v-if="showForm">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" rows="8" cols="80" v-model="event.description"></textarea>
      </div>
      <div class="form-group">
        <label>Date</label>
      ...
      <button type="submit" class="btn btn-primary btn-sm" @click="addEvent">Submit</button>
    </div>
  </div>
</template>
